...
🏗 Architecture 
InsightCric utilizes a Microservices-based architecture to ensure independent scalability and 
high availability. 
...
└────────────────────────────────────────────────────┘ 
    ...
    │(news_db | playerperformanceanalyzer | match_preview_review | WinPredictor) │ 
    └──────────────────────────────────────────────-----------------------------─┘ 
...
│   ├── src/ 
# React Frontend 
│   │   ├── components/     # UI Elements (Dashboard, Login, Sidebar, etc.) 
│   │   ├── App.jsx         
# Main App Component 
│   │   └── main.jsx        
├── server/                 
...
# Backend Cluster 
# API Gateway Service 
│   ├── microservice-1/     # News Service 
│   ├── microservice-2/     # Player Stats Service 
│   ├── microservice-3/     # Match Analysis Service 
│   ├── microservice-4/     # Win Prediction Service 
│   └── package.json        
# Root Orchestration 
└── README.md 

ML-based win predictor 
